...
// Fecha o menu e rola suavemente ao clicar num item
...
/* ----------------------------------------------------------------------
   2.b LINKS "data-action" (Dress Code, Presentes, Mapa, Contato)
   ----------------------------------------------------------------------
   Essas seções não fazem parte do scroll principal da página — a ideia
   é que cada uma vire uma função própria (ex: abrir um modal, uma
   página separada, ou um link externo), plugada aqui.

   Para plugar sua implementação, basta preencher o objeto abaixo:

     const sectionActions = {
       dresscode: () => { ...abra seu modal/seção de dress code... },
       presentes: () => { ...abra sua lista de presentes/Pix... },
       mapa:      () => { ...abra seu mapa/modal de localização... },
       contato:   () => { ...abra seu WhatsApp/telefone/contato... },
     };

   Por enquanto, cada clique só fecha o menu (se estiver aberto) e
   avisa no console qual ação foi chamada, sem quebrar nada.
   ---------------------------------------------------------------------- */

const sectionActions = {
  dresscode: () => console.info("[Convite] TODO: implementar ação de Dress Code"),
  presentes: () => console.info("[Convite] TODO: implementar ação de Presentes"),
  mapa: () => console.info("[Convite] TODO: implementar ação de Mapa"),
  contato: () => console.info("[Convite] TODO: implementar ação de Contato"),
};
...
document.querySelectorAll("[data-action]").forEach((link) => {
  link.addEventListener("click", (e) => {
    ...
    if (sectionActions[action]) sectionActions[action]();
  });
});
